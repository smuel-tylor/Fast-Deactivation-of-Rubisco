...
# - using the same data/factors etc. as 082005summarize.R
...
pdf(here("output/082005NaturePlantsnlmeLightResponses_nlme2.pdf"),
    w = 6, h = 9
    )							
...
save(AQ.fixed,
     AQ.nlme2,
     AQ,
     file = here("output/082005NaturePlantsnlmeLightResponses.Rdata")
)
